        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form action="{{ isset($member) ? route('members.update', $member['id']) : route('members.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-between gap-6">
                    ...
                    <div class="w-9/12 p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('name', $member['name'] ?? '') }}" required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            <label for="pazzia" class="block text-gray-700 font-semibold">{{ __('Pazzia') }}: <span id="pazzia_value">{{ old('characteristics.pazzia', $member['characteristics']['pazzia'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[pazzia]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.pazzia', $member['characteristics']['pazzia'] ?? 5) }}" oninput="updateChart()" required>
                        ...
                        <div class="mb-4">
                            <label for="alcolismo" class="block text-gray-700 font-semibold">{{ __('Alcolismo') }}: <span id="alcolismo_value">{{ old('characteristics.alcolismo', $member['characteristics']['alcolismo'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[alcolismo]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.alcolismo', $member['characteristics']['alcolismo'] ?? 5) }}" oninput="updateChart()" required>
                        ...
                        <div class="mb-4">
                            <label for="resistenza" class="block text-gray-700 font-semibold">{{ __('Resistenza') }}: <span id="resistenza_value">{{ old('characteristics.resistenza', $member['characteristics']['resistenza'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[resistenza]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.resistenza', $member['characteristics']['resistenza'] ?? 5) }}" oninput="updateChart()" required>
                        ...
                        <div class="mb-4">
                            <label for="socialita" class="block text-gray-700 font-semibold">{{ __('Socialita') }}: <span id="socialita_value">{{ old('characteristics.socialita', $member['characteristics']['socialita'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[socialita]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.socialita', $member['characteristics']['socialita'] ?? 5) }}" oninput="updateChart()" required>
                        ...
                        <div class="mb-4">
                            <label for="seduzione" class="block text-gray-700 font-semibold">{{ __('Seduzione') }}: <span id="seduzione_value">{{ old('characteristics.seduzione', $member['characteristics']['seduzione'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[seduzione]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.seduzione', $member['characteristics']['seduzione'] ?? 5) }}" oninput="updateChart()" required>
                        ...
                        <div class="mb-4">
                            <label for="professionalita" class="block text-gray-700 font-semibold">{{ __('Professionalita') }}: <span id="professionalita_value">{{ old('characteristics.professionalita', $member['characteristics']['professionalita'] ?? 5) }}</span></label>
                            <input type="range" min="0" max="10" name="characteristics[professionalita]" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('characteristics.professionalita', $member['characteristics']['professionalita'] ?? 5) }}" oninput="updateChart()" required>
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-gray-100 border-t border-gray-300 py-3 px-6 flex justify-end">
                    <a href="{{ route('members.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded mr-2">
                        {{ __('Cancel') }}
                    </a>
