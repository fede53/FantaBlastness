            ...
            <div class="flex gap-8"> <!-- Struttura a due colonne -->
                ...
                <form action="{{ route('teams.store') }}" method="POST">
                    ...
                    <div class="flex justify-between gap-6 relative">
                        ...
                        <div class="mb-8 ">
                            <label for="name" class="block text-white font-semibold">{{ __('Team Name') }}</label>
                            <input type="text" name="name" id="name" class="mt-1 block w-full rounded-md shadow-sm" placeholder="Enter team name" required>
                            @error('name')
                        ...
                        <div class="w-3/12 p-4 pt-0 sm:pr-8 sm:pb-8 sm:pl-8 flex  flex-col items-center sticky">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <h3 id="selected_count" class="text-xl font-semibold text-white ml-4">Selected: 0</h3>
                            </div>
